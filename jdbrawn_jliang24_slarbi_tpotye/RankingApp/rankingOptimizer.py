...
class rankingOptimizer(dml.Algorithm):
 ...
 #       self.finishRanking = finalRanking
        #print(finalRanking)
 ...
 #       return("Original Ranking" + originalRanking, "Final Ranking" + finalRanking)

 #       return ('{:f}'.format(self.finishRanking))
        all_stats= [str(SCHOOL_NAME), str(maxRanking) + "/" + str(overall_score.count()),str(currentRanking) + "/" + str(overall_score.count()), str(finalSocialWeight), str(finalTransitWeight), str(finalSafetyWeight), str(33.3), str(33.3), str(33.3)]
        #return {"start": startTime, "end": endTime}
        #return("Final Ranking" + str(finalRanking), "Old Ranking" + str(originalRanking), "Social Weight: " + str(finalSocialWeight), "Transit Weight: " + str(finalTransitWeight), "Safety Weight: " + str(finalSafetyWeight) )
        return(all_stats)
