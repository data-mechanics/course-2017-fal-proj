...
class income(dml.Algorithm):
    ...
    reads = []
    writes = ['gaudiosi_raykatz_nedg.income']
    ...
    def execute(trial = False):
        ...
        repo['gaudiosi_raykatz_nedg.income'].insert_many(r)
        repo['gaudiosi_raykatz_nedg.income'].metadata({'complete':True})
        print(repo['gaudiosi_raykatz_nedg.income'].metadata())
        repo.logout()
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        income = doc.entity('dat:gaudiosi_raykatz_nedg#income', {prov.model.PROV_LABEL:'Income', prov.model.PROV_TYPE:'ont:DataSet'})
