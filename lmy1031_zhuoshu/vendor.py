...
class example(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        repo.dropCollection("vendor")
        repo.createCollection("vendor")
        repo['lmy1031_zhuoshu_vendor'].insert_many(r)
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        doc.add_namespace('vendor', 'https://data.cityofboston.gov/')

        this_script = doc.agent('alg:#vendor', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        resource = doc.entity('vendor:xgbq-327x', {'prov:label':'vendor', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        ...
        public = doc.entity('dat:#vendor', {prov.model.PROV_LABEL:'vendor', prov.model.PROV_TYPE:'ont:DataSet'})
