...
class aggpropValue(dml.Algorithm):
    contributor = 'wongi'
    reads = ['wongi.propValue']
    writes = ['wongi.aggpropValue']
    ...
    def execute(trial = False):
        ...
        for entry in repo.wongi.propValue.find():
        ...
        #print("final", final)
        repo['wongi.aggpropValue'].insert_many(final)
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:wongi#aggpropValue', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        
        resource_properties = doc.entity('dat:wongi#propValue', {'prov:label':'Property Value', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        ...
        aggregateProperty = doc.entity('dat:wongi#aggpropValue', {prov.model.PROV_LABEL:'Aggregate Properties', prov.model.PROV_TYPE:'ont:DataSet'})
