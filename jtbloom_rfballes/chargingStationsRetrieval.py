...
class chargingStations(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        repo['jtbloom_rfballes.chargingStations'].insert_many(r)
        repo['jtbloom_rfballes.chargingStations'].metadata({'complete':True})
        print(repo['jtbloom_rfballes.chargingStations'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:jtbloom_rfballes#chargingStationsRetrieval', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
