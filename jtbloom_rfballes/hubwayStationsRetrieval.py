...
class hubwayStations(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        repo['jtbloom_rfballes.hubwayStations'].insert_many(r)
        repo['jtbloom_rfballes.hubwayStations'].metadata({'complete':True})
        print(repo['jtbloom_rfballes.hubwayStations'].metadata())
