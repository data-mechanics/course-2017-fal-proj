...
class library_rain_correlation(dml.Algorithm):
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        rain_db = doc.entity('dat:sbrz_nedg#rainData',{'prov:label': 'rainData', prov.model.PROV_TYPE: 'ont:DataSet'})
        visit_db = doc.entity('dat:sbrz_nedg#libraryData',{'prov:label': 'libraryData', prov.model.PROV_TYPE: 'ont:DataSet'})
