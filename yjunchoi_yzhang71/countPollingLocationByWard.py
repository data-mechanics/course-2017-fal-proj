...
class countPollingLocationByWard(dml.Algorithm):
    ...
    reads = ['yjunchoi_yzhang71.pollingLocation', 'yjunchoi_yzhang71.presidentElectionByPrecinct']
    writes = ['yjunchoi_yzhang71.countPollingLocationByWard']
    ...
    def execute(trial = False):
        ...
        repo['yjunchoi_yzhang71.countPollingLocationByWard'].insert(countLocation)
        repo['yjunchoi_yzhang71.countPollingLocationByWard'].metadata({'complete': True})
        print("Saved countPollingLocationByWard", repo['yjunchoi_yzhang71.countPollingLocationByWard'].metadata())
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        countPollingLocationByWard = doc.entity('dat:yjunchoi_yzhang71#countPollingLocationByWard',
