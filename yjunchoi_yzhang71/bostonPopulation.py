...
class bostonPopulation(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        url = 'https://raw.githubusercontent.com/WHYjun/course-2017-fal-proj/master/local_data/BostonPopulation.csv'
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        doc.add_namespace('cen', 'https://www.census.gov/quickfacts/fact/map/brooklinecdpmassachusetts,bostoncitymassachusetts/') # Massachusetts Election Statistics
        ...
        resource = doc.entity('cen:PST045216#viewtop', {'prov:label':'Boston Population Estimates 2016', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'csv'})
