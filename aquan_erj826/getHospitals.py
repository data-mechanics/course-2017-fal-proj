...
class getHospitals(dml.Algorithm):
    ...
    reads = []
    writes = ['aquan_erj826.hospitals']

    @staticmethod
    def execute(trial = False):
        '''Retrieve hospital location data set from analyze Boston.'''
        ...
        repo['aquan_erj826.hospitals'].insert_many(r)
        repo['aquan_erj826.hospitals'].metadata({'complete':True})
        print(repo['aquan_erj826.hospitals'].metadata())
