...
class getCrimes(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        repo['bohorqux_rocksdan.crimes'].insert_many(r)
        repo['bohorqux_rocksdan.crimes'].metadata({'complete':True})
        print(repo['bohorqux_rocksdan.crimes'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:bohorqux_rocksdan#getCrimes', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        crimes = doc.entity('dat:bohorqux_rocksdan#crimes', {prov.model.PROV_LABEL:'Crime Report', prov.model.PROV_TYPE:'ont:DataSet'})
