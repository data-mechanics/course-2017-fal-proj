...
class getAccidents(dml.Algorithm):
    contributor = 'alanbur_aquan_erj826_jcaluag'
    reads = []
    writes = ['alanbur_aquan_erj826_jcaluag.accidents']
    ...
    def execute(trial = False):
        ...
        repo['alanbur_aquan_erj826_jcaluag.accidents'].insert(r, check_keys=False)
        repo['alanbur_aquan_erj826_jcaluag.accidents'].metadata({'complete':True})
        print(repo['alanbur_aquan_erj826_jcaluag.accidents'].metadata())
