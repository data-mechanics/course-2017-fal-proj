...
class getComplaints(dml.Algorithm):
    ...
    reads = []
    writes = ['alanbur_aquan_erj826_jcaluag.complaints']
    ...
    def execute(trial = False):
        ...
        repo['alanbur_aquan_erj826_jcaluag.complaints'].insert(r, check_keys=False)
        repo['alanbur_aquan_erj826_jcaluag.complaints'].metadata({'complete':True})
        print(repo['alanbur_aquan_erj826_jcaluag.complaints'].metadata())
