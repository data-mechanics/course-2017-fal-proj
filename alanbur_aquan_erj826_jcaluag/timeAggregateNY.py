...
class timeAggregateNY(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        repo.dropCollection("alanbur_aquan_erj826_jcaluag.timeAggregateNY")
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        #define the agent
        this_script = doc.agent('alg:alanbur_aquan_erj826_jcaluag#timeAggregateNY', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
