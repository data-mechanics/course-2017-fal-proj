...
class getComplaints(dml.Algorithm):
    ...
    reads = []
    writes = ['alanbur_aquan_erj826_jcaluag.parseaccidents']
    ...
    def execute(trial = False):
        ...
        collection = repo.alanbur_aquan_erj826_jcaluag.accidents

        repo.dropCollection("alanbur_aquan_erj826_jcaluag.parseaccidents")
        repo.createCollection("alanbur_aquan_erj826_jcaluag.parseaccidents")
        ...
        for entry in collection.find():
            ...
            repo['alanbur_aquan_erj826_jcaluag.parseaccidents'].insert(n, check_keys=False)


        repo['alanbur_aquan_erj826_jcaluag.parseaccidents'].metadata({'complete':True})
        print(repo['alanbur_aquan_erj826_jcaluag.parseaccidents'].metadata())
