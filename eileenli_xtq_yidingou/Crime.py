...
class example(dml.Algorithm):
    ...
    reads = []
    writes = ['eileenli_yidingou.Crime']
    ...
    def execute(trial = False):
        ...
        repo['eileenli_yidingou.Crime'].insert_many(r)
        repo['eileenli_yidingou.Crime'].metadata({'complete':True})
        print(repo['eileenli_yidingou.Crime'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        Crime = doc.entity('dat:eileenli_yidingou#Crime', {prov.model.PROV_LABEL:'NightLife Crime', prov.model.PROV_TYPE:'ont:DataSet'})
