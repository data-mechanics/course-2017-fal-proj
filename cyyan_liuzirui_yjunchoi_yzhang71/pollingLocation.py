...
class pollingLocation(dml.Algorithm):
    ...
    reads = []
    writes = ['cyyan_liuzirui_yjunchoi_yzhang71.pollingLocation']
    ...
    def execute(trial = False):
        ...
        repo['cyyan_liuzirui_yjunchoi_yzhang71.pollingLocation'].insert_many(results)
        repo.logout()
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:cyyan_liuzirui_yjunchoi_yzhang71#pollingLocation', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        pollingLocation = doc.entity('dat:cyyan_liuzirui_yjunchoi_yzhang71#pollingLocation', {prov.model.PROV_LABEL:'Polling Location', prov.model.PROV_TYPE:'ont:DataSet'})
