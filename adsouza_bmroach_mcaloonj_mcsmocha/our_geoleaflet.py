...
Original file provided by github.com/data-mechanics
...
def html(obj, src='https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.0.3', service='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png'):
    ...
    L.geoJson(obj, {
      ...
      pointToLayer:
        function (feature, latlng) {
          return L.circleMarker(latlng, {radius:6, weight:0.1, fillColor:"#ff0000", color:"#ff0000", opacity:1, fillOpacity:1});
        }
    }).addTo(leaflet);
</script>'''
  return "<!DOCTYPE html>\n<html>\n  <head>\n    " + meta + "\n    " + link +\
