    ...
    def execute(trial = False):
        ...
        for stop in stops[1:]:
            ...
            try:
                ...
                if(float(s[4])<42.332299 or float(s[4])>42.375863 or float(s[5]) < -71.173850 or float(s[5])>-70.990035):
                    continue
            except ValueError:
                continue
        ...
        for f in food:
            try:
                ...
                x = temp['location'][0]
                y = temp['location'][1]
                if(x<42.332299 or x>42.375863 or y < -71.173850 or y>-70.990035):
                    continue
