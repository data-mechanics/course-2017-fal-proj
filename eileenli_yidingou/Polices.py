...
class example(dml.Algorithm):
    ...
    reads = []
    writes = ['eileenli_yidingou.Polices']
    ...
    def execute(trial = False):
        ...
        repo['eileenli_yidingou.Polices'].insert_many(r)
        repo['eileenli_yidingou.Polices'].metadata({'complete':True})
        print(repo['eileenli_yidingou.Polices'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        doc.usage(get_Polices, resource, startTime, None,
                  ...
                  'ont:Query':'?type=NightLife+Polices&$select=type,latitude,longitude,OPEN_DT'
                  }
                  )

        Polices = doc.entity('dat:eileenli_yidingou#Polices', {prov.model.PROV_LABEL:'NightLife Polices', prov.model.PROV_TYPE:'ont:DataSet'})
