...
class example(dml.Algorithm):
    ...
    reads = []
    writes = ['eileenli_yidingou.Restaurants']
    ...
    def execute(trial = False):
        ...
        repo['eileenli_yidingou.Restaurants'].insert_many(r)
        repo['eileenli_yidingou.Restaurants'].metadata({'complete':True})
        print(repo['eileenli_yidingou.Restaurants'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:eileenli_yidingou#mtba', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        doc.usage(get_Restaurants, resource, startTime, None,
                  ...
                  'ont:Query':'?type=NightLife+Restaurants&$select=type,latitude,longitude,OPEN_DT'
                  }
                  )

        Restaurants = doc.entity('dat:eileenli_yidingou#Restaurants', {prov.model.PROV_LABEL:'NightLife Restaurants', prov.model.PROV_TYPE:'ont:DataSet'})
