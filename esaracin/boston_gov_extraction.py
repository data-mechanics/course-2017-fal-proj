...
class boston_gov_extraction(dml.Algorithm):
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        doc.add_namespace('gov', 'https://data.boston.gov/dataset') # Namespace specific to this script
        ...
        resource = doc.entity('gov:6220d948-eae2-4e4b-8723-2dc8e67722a3/resource/12cb3883-56f5-47de-afa5-3b1cf61b257b/',
        ...
        doc.usage(get_guns, resource, startTime, None, {prov.model.PROV_TYPE:'ont:Retrieval'})
        ...
        doc.wasDerivedFrom(guns, resource, get_guns, get_guns, get_guns)
...
boston_gov_extraction.provenance()
